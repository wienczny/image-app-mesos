...
# Install Mesos
RUN wget -qO /tmp/mesos.tar.gz http://www.apache.org/dist/mesos/0.22.1/mesos-0.22.1.tar.gz \
 && tar -C /tmp/ -xzf /tmp/mesos.tar.gz && rm -f /tmp/mesos.tar.gz \
 && mkdir /tmp/mesos-0.22.1/build \
 && cd /tmp/mesos-0.22.1/build \
